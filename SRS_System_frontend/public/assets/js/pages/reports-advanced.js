(function(){
  document.addEventListener('DOMContentLoaded', ()=>{
    ...
    function renderHeatmap(){
      ...
      const depts = ['المراسلات الإدارية','العمليات','الشؤون القانونية','اللوجستيات','تقنية المعلومات'];
    ...
    function renderDeptProductivity(){
      ...
      const labels = ['المراسلات الإدارية','العمليات','الشؤون القانونية','اللوجستيات','تقنية المعلومات'];
