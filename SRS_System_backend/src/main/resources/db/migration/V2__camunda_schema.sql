-- =============================================================================
-- Camunda BPM 7.22.0 — PostgreSQL DDL (engine + history + identity + CMMN + DMN)
-- Source: camunda-engine-7.22.0.jar org/camunda/bpm/engine/db/create/activiti.postgres.create.*.sql
-- Licensed under Apache License 2.0 (see NOTICE in Camunda distribution).
-- Tables are created in schema srs_system via search_path (matches camunda.bpm.database).
--
-- UPGRADE: If Camunda previously created ACT_* tables via schema-update, this migration will
-- fail with "already exists". Option A: fresh DB / run docs/db/srs_system_full_clean_reset.sql.
-- Option B: drop only Camunda ACT_* objects in srs_system, then re-run Flyway (data loss for engine).
-- application.yml must set camunda.bpm.database.schema-update: false after this migration.
-- =============================================================================

SET search_path TO srs_system, public;

-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.engine.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.history.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.identity.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.case.engine.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.case.history.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.decision.engine.sql ----------
...
-- ---------- org_camunda_bpm_engine_db_create_activiti.postgres.create.decision.history.sql ----------
