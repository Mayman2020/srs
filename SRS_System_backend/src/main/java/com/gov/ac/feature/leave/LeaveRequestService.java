...
public class LeaveRequestService {
  ...
  @Transactional
  public LeaveRequestDto create(UUID actorId, CreateLeaveRequest req) {
  ...
  @Transactional
  public LeaveRequestDto decide(UUID id, UUID deciderId, DecideLeaveRequest req) {
  ...
  private static LeaveRequestDto toDto(LeaveRequest lr) {
    AppUser u = lr.getUser();
    AppUser dec = lr.getDecidedBy();
