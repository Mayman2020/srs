...
public interface RoleRepository extends JpaRepository<RoleEntity, Long> {
  ...
  List<RoleEntity> findByDeletedAtIsNullOrderBySortOrderAsc();

  Optional<RoleEntity> findByIdAndDeletedAtIsNullAndActiveTrue(Long id);

  List<RoleEntity> findByIdInAndDeletedAtIsNullAndActiveTrue(List<Long> ids);

  Optional<RoleEntity> findByCodeIgnoreCaseAndDeletedAtIsNullAndActiveTrue(String code);
