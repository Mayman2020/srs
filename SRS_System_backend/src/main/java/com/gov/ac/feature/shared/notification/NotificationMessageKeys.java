package com.gov.ac.feature.shared.notification;

/**
 * i18n keys for {@link com.gov.ac.feature.notification.inbox.entity.InAppNotificationEntity#getMessageKey()}; resolved in
